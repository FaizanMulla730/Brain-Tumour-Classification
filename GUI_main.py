...
from tkinter.filedialog import askopenfilename ##to open another window from one window
...
root.title("Brain tumour and classification detection ")
...
image2 = image2.resize((1830, 900), Image.ANTIALIAS)
...
#
label_l1 = tk.Label(root, text="Brain tumour and classification detection",font=("Times New Roman", 35, 'bold'),
